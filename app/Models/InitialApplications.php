...
class InitialApplications extends Model
{
    ...
    protected $fillable = ['initapp_id', 'fac_id', 'user_id', 'submission_date', 'remarks', 'application_status', 'late_remarks', 'inspector_date_action', 'inspector_date_reaction', 'late_date', 'inspection_id', 'inspector_date_rejected'];
