...
class FacilityInspection extends Model
{
    ...
    protected $fillable = ['inspection_date', 'fac_id', 'inspector_name', 'inspection_date', 'inspection_status', 'reinspection_status', 'reinspection_date', 'inspection_form', 'inspection_type', 'remarks', 'date_successful'];
